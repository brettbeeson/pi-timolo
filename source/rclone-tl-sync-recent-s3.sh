...
remoteDir="tmv.brettbeeson.com.au/picam/recent"        # Destination Folder on Remote
rcloneParam="sync -L --s3-acl=public-read"    # -L follow symlinks. other options  Eg sync, copy, move 
