...
rcloneName="t1000"     # Name of Remote Storage Service
syncRoot="/home/pi/pi-timolo"   # Root Folder to Start
localDir="media/timelapse"         # Source Folder on Local
remoteDir="pi-timolo/media/picam/photos"        # Destination Folder on Remote
rcloneParam="move -L"    # -L follow symlinks. other options  Eg sync, copy, move 
